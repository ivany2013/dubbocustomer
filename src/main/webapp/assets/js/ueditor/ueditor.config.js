...
(function () {
    ...
    var l = "../../assets/js/ueditor/themes/iframe.css",
        r = window.UEDITOR_HOME_URL || e();
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: URL + "/article/file/upload"
        ...
        toolbars: [
            ["bold", "underline", "justifyleft", "justifycenter", "justifyright", "insertunorderedlist", "insertorderedlist", "blockquote", "removeformat", "|", "simpleupload", "insertimage", "fullscreen"]
        ],
        iframeUrlMap: {
            anchor: "~/dialogs/anchor/anchor.html",
            ...
            insertframe: "~/dialogs/insertframe/insertframe1.html",
            ...
            images: "~/dialogs/image/image.html",
            //testwin: "~/dialogs/image/testwin.html",
		...
		,whitList: {
			...
			del:    ['datetime'],
			details: ['open'],
			div:    ['class', 'style','source','url','title'],
			dl:     ['class', 'style'],
			dt:     ['class', 'style'],
			em:     ['class', 'style'],
			...
			hr:     [],
			i:      ['class', 'style'],
			img:    ['src', 'alt', 'title', 'width', 'height', 'id', '_src', 'loadingclass', 'class', 'data-latex','source','url'],
			ins:    ['datetime'],
			li:     ['class', 'style'],
			mark:   [],
			nav:    [],
